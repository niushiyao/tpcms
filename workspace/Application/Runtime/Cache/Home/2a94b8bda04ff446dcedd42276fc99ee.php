  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          <?php if(is_array($jiaodian_pic)): foreach($jiaodian_pic as $key=>$pic): ?><div class="banner-left">
            <img src="<?php echo ($pic["thumb"]); ?>" alt="" width="670" height="360">
          </div><?php endforeach; endif; ?>
          <div class="banner-right">
            <ul>
              <?php if(is_array($small_pic)): foreach($small_pic as $key=>$spic): ?><li>
                <img src="<?php echo ($spic["thumb"]); ?>" alt="" width="150" height="113">

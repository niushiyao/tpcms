    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <form action="/admin.php" method="get">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <input class="form-control" name="title" type="text" value="<?php echo ($search_title); ?>" placeholder="文章标题" />
            ...
            <div class="col-lg-6">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <tbody>
                        <?php if(is_array($PositionContentList)): foreach($PositionContentList as $key=>$content): ?><tr>
                                <td><input size=4 type='text'  name='listorder' value="<?php echo ($content["listorder"]); ?>"/></td>
                                <td><?php echo ($content["id"]); ?></td>
                                <td><?php echo ($content["title"]); ?></td>
                                <td><?php echo (date('Y-m-d H:i:s',$content["create_time"])); ?></td>
                                <td><img src="<?php echo ($content["thumb"]); ?>" width="100" height="100"></td>
                                <td>
                                    <span attr-status="0"  attr-id="<?php echo ($content["id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off" ><?php echo (getStatus($content["status"])); ?></span>
                                </td>
                                <td>
                                    <span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($content["id"]); ?>" ></span>
                                    <a href="javascript:void(0)" id="singcms-delete"  attr-id="<?php echo ($content["id"]); ?>"  attr-message="删除">

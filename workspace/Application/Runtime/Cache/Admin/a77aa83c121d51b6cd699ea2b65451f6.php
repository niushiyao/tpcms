            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="name" value="<?php echo ($menu_info["name"]); ?>" class="form-control" id="inputname" placeholder="请填写菜单名">
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="type" <?php if($menu_info["type"] == 1): ?>checked<?php endif; ?> id="optionsRadiosInline1" value="1" checked> 后台菜单
                            <input type="radio" name="type" <?php if($menu_info["type"] == 0): ?>checked<?php endif; ?> id="optionsRadiosInline2" value="0"> 前端栏目
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" value="<?php echo ($menu_info["m"]); ?>" class="form-control" name="m" id="inputPassword3" placeholder="模块名如admin">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">控制器:</label>
                        <div class="col-sm-5">
                            <input type="text" value="<?php echo ($menu_info["c"]); ?>" class="form-control" name="c" id="inputPassword3" placeholder="控制器如index">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">方法:</label>
                        <div class="col-sm-5">
                            <input type="text" value="<?php echo ($menu_info["f"]); ?>" class="form-control" name="f" id="inputPassword3" placeholder="方法名如index">
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="status" <?php if($menu_info["status"] == 1): ?>checked<?php endif; ?> id="optionsRadiosInline1" value="1" checked> 开启
                            <input type="radio" name="status" <?php if($menu_info["status"] == 0): ?>checked<?php endif; ?> id="optionsRadiosInline2" value="0"> 关闭
                        </div>
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/admin.php?c=menu&a=edit&id=' + <?php echo I('get.id');?>,

        ...
        <div class="row" style="margin-bottom: 12px;">
            <form action="/admin.php" method="get">
                ...
                <div class="input-group" style="float: left;width:20%">
                    ...
                    <input class="form-control" type="text" name="name" value="<?php echo ($search_name); ?>">
                </div>
				<div class="input-group" style="width:20%;padding-left: 12px;">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($PositionList)): $i = 0; $__LIST__ = $PositionList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo (getStatus($position["status"])); ?></td>
                                <td><span class="glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($position["id"]); ?>"></span>    <a href="javascript:void(0)" attr-id="<?php echo ($position["id"]); ?>" id="singcms-delete"  attr-a="position" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>

...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="col-lg-12">
			...
			<a href="/admin.php?c=basic&a=cache"><button type="button" class="btn btn-primary</if>"> 缓存配置</button></a>
		</div>
		</div>
		<!-- /.row -->
			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="title" value="<?php echo ($basic_info["title"]); ?>" class="form-control" id="inputname" placeholder="请填写站点标题">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" value="<?php echo ($basic_info["keywords"]); ?>" name="keywords" id="inputPassword3" placeholder="请填写站点关键词">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">站点描述:</label>
						<div class="col-sm-5">
							<textarea class="form-control" rows="3" name="description"><?php echo ($basic_info["description"]); ?></textarea>
						</div>
					</div>
